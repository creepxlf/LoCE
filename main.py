...
class Main(tk.Frame):
    ...
    def init_main(self):
        toolbar = tk.Frame(bg="#cd7f32", bd=2)
        toolbar.pack(side=tk.TOP, fill=tk.X)
        self.add_img = tk.PhotoImage(file="./img/add.png")
        btn_open_dialog = tk.Button(
            toolbar, bg="#cd853f", bd=0, image=self.add_img, command=self.open_dialog
        )
        ...
        self.tree.column("ID", width=30, anchor=tk.CENTER)                   #Табличка
        ...
        self.update_img = tk.PhotoImage(file="./img/update.png")   #добавить
        ...
        self.delete_img = tk.PhotoImage(file="./img/delete.png")     #обновить
        ...
        self.search_img = tk.PhotoImage(file="./img/search.png")    #поиск
    ...
    def update_records(self, name, tel, email, salary):      #UPDATE 
    ...
    def delete_records(self):      #DELETE
...
class Update(Child):
    ...
    def init_edit(self):   #редактировать
...
class DB:
    def __init__(self):
        self.conn = sqlite3.connect("db.db")    # БАЗА ДАННЫХ
...
if __name__ == "__main__":    #приложение
    root = tk.Tk()
    db = DB()
    app = Main(root)
    app.pack()
...
###############################################################################################
#   #Приложение ‘Список сотрудников компании’, которое хранит следующую информацию:           #
#    #ФИО, номер телефона,                                                                    #
#    #адрес электронной почты, заработная плата.                                              #
#                                                                                             #
#   #Данные хранятся в БД. В приложении должны быть реализован следующий функционал:          #
